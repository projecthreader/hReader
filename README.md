...
Each patient stores a list of applets that the user has configured. Available applets are loaded from `HReaderApplets.plist` and can be accessed through `HRAppletConfigurationViewController`.
